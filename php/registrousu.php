...
<?php
    if ((isset($_POST["MM_insert"]))&&($_POST["MM_insert"]=="formreg"))
    {
        ...
        $validar ="SELECT * FROM usuarios WHERE numero_tar='$cedula' or email='$usuario'";
       ...
       if ($fila1) {
        ...
        else
        {
           ...
           $insertsql="INSERT INTO usuarios(numero_tar,nombre,email,password,tipo_usuario, estado) VALUES('$cedula','$nombre','$usuario','$clave','$idusu', 1)";
...
<body>
    <div class="login-box">
        <img src="controller/image/moon (1).png" class="avatar" alt="Imagen Avar">
        ...
        <form method="POST" name="formreg" autocomplete="off">
            ...
            <input type="text" name="user" placeholder="Ingrese un Email" >
