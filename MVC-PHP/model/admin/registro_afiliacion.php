...
}else if (isset($_POST["btn-editar"]))
{
	...
	$var2 = $_POST['fecha_afiliacion'];
	$var3 = $_POST['id_afiliacion'];
	$sql_edit = "UPDATE `afiliacion` SET `fecha_afiliacion`='$var2',`id_mascota`='$var1' WHERE `id_afiliacion` = '$var3'; ";
...
{
	$var1 = $_POST['id_afiliacion'];
	$sql_delete = "DELETE FROM `afiliacion` WHERE `id_afiliacion` = '$var1'";
