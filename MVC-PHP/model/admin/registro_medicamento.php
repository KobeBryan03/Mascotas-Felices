...
{
	$var1 = $_POST['medicamento'];
	$var2 = $_POST['id_tipousu'];
	$sql_edit = "UPDATE `medicamentos` SET `id_medicamentos`='$var2',`medicamento`='$var1' WHERE `id_medicamentos` = '$var2'; ";
...
}else if (isset($_POST["btn-eliminar"]))
{
	...
	$sql_delete = "DELETE FROM `medicamentos` WHERE `id_medicamentos` = '$var1'";
